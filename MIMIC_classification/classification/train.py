...
def train(train_df, train_df_size, val_df, val_df_size, PATH_TO_IMAGES, modeltype, CRITERION, device,lr):
    """
    ...
    random_seed = random.randint(0,100) #run1 = seed100
    ...
    train_loader = torch.utils.data.DataLoader(
        MIMICCXRDataset(train_df, PATH_TO_IMAGES, transform=transforms.Compose([
    ...
    val_loader = torch.utils.data.DataLoader(
        MIMICCXRDataset(val_df,PATH_TO_IMAGES, transform=transforms.Compose([
                                                                #transforms.Resize(256),
                                                                transforms.CenterCrop(256),
                                                                transforms.ToTensor(),
                                                                normalize
...
#--------------------------Start of epoch loop
    ...
    prog_bar = tqdm(range(start_epoch,num_epochs))
